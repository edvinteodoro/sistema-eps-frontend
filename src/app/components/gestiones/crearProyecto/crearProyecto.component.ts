...
export class CrearProyectoComponent implements OnInit {
    ...
    constructor(private confirmationService: ConfirmationService, private messageService: MessageService, private carreraService: CarreraService,
        private usuarioService: UsuarioService, private proyectoService: ProyectoService, private router: Router) { }
            ...
            accept: () => {
                if (this.validarCampos()) {
                    ...
                    this.proyectoService.crearProyecto(this.proyecto).subscribe((res: any) => {
                        this.messageService.add({ key: 'tst', severity: 'success', summary: 'Proyecto Creado', detail: 'Se ha creado el proyecto existosamente' });
                        setTimeout(() => {
                            this.loading = false;
