...
export class ProyectoService {
  ...
  crearProyecto(proyecto: Proyecto): Observable<Proyecto> {
    return this.http.post<any>('http://localhost:8080/api/proyectos', proyecto);
  }

  actualizarProyecto(idProyecto: number, proyecto: Proyecto): Observable<Proyecto> {
    return this.http.put<any>('http://localhost:8080/api/proyectos/' + idProyecto, proyecto);
  }
  ...
  agregarElementoProyecto(idProyecto: number, idElemento: number, elementoProyecto: ElementoProyecto) {
    ...
    return this.http.post<any>('http://localhost:8080/api/proyectos/' + idProyecto + '/elementos/' + idElemento + '/elemento-proyecto', formData);
  }

  desactivarElementoProyecto(idElementoProyecto: number) {
    return this.http.put<any>('http://localhost:8080/api/elementos/' + idElementoProyecto + '/desactivar', {});
  }
  ...
  getElementoProyecto(idProyecto: number, idElemento: number) {
    return this.http.get<any>('http://localhost:8080/api/proyectos/' + idProyecto + '/elementos/' + idElemento + '/elemento-proyecto');
  }
  ...
  getProyectosActivos(): Observable<Proyecto[]> {
    return this.http.get<any>('http://localhost:8080/api/proyectos/activos');
  }

  getPersonaAsesor(idProyecto: number): Observable<Usuario> {
    return this.http.get<any>('http://localhost:8080/api/proyectos/' + idProyecto + '/personas/asesor');
  }

  getUsuarioAsesor(idProyecto: number): Observable<Usuario> {
    return this.http.get<any>('http://localhost:8080/api/proyectos/' + idProyecto + '/usuarios/asesor');
  }

  actualizarAsesorProyecto(idProyecto: number, asesor: Usuario): Observable<Usuario> {
    return this.http.put<any>('http://localhost:8080/api/proyectos/' + idProyecto + '/usuarios/asesor', asesor);
  }

  actualizarSupervisorProyecto(idProyecto: number, supervisor: Usuario): Observable<Usuario> {
    return this.http.put<any>('http://localhost:8080/api/proyectos/' + idProyecto + '/usuarios/supervisor', supervisor);
  }

  actualizarContraparteProyecto(idProyecto: number, contraparte: Usuario): Observable<Usuario> {
    return this.http.put<any>('http://localhost:8080/api/proyectos/' + idProyecto + '/usuarios/contraparte', contraparte);
  }

  getPersonaContraparte(idProyecto: number): Observable<Usuario> {
    return this.http.get<any>('http://localhost:8080/api/proyectos/' + idProyecto + '/personas/contraparte');
  }

  getUsuarioContraparte(idProyecto: number): Observable<Usuario> {
    return this.http.get<any>('http://localhost:8080/api/proyectos/' + idProyecto + '/usuarios/contraparte');
  }
  ...
  actualizarPersona(idProyecto: number, idPersona: String, persona: Usuario): Observable<Usuario> {
    return this.http.put<any>('http://localhost:8080/api/proyectos/' + idProyecto + '/personas/' + idPersona, persona);
  }

  getInstitucion(idProyecto: number): Observable<Institucion> {
    return this.http.get<any>('http://localhost:8080/api/proyectos/' + idProyecto + '/institucion');
  }

  actualizarInstitucion(idProyecto: number, institucion: Institucion): Observable<Institucion> {
    return this.http.put<any>('http://localhost:8080/api/proyectos/' + idProyecto + '/institucion', institucion);
  }

  getAsesoresTecnicos(idProyecto: number): Observable<Usuario[]> {
    return this.http.get<any>('http://localhost:8080/api/proyectos/' + idProyecto + '/personas/asesores-tecnicos');
  }
  ...
  agregarAsesorTecnicos(idProyecto: number, asesorTecnico: Usuario): Observable<Usuario> {
    return this.http.post<any>('http://localhost:8080/api/proyectos/' + idProyecto + '/personas/asesores-tecnicos', asesorTecnico);
  }

  eliminarAsesorTecnicos(idProyecto: number, idAsesorTecnico: String) {
    return this.http.delete<any>('http://localhost:8080/api/personas/' + idAsesorTecnico);
  }

  getSupervisor(idProyecto: number): Observable<Usuario> {
    return this.http.get<any>('http://localhost:8080/api/proyectos/' + idProyecto + '/usuarios/supervisor');
  }

  getComentariosEtapa(idProyecto: number, etapaId: number): Observable<Comentario[]> {
    return this.http.get<any>('http://localhost:8080/api/proyectos/' + idProyecto + '/etapa/' + etapaId + '/comentarios');
  }
  ...
  getComentarios(idProyecto: number, page: number, size: number): Observable<any> {
    ...
    return this.http.get<any>('http://localhost:8080/api/proyectos/' + idProyecto + '/comentarios', { params });
  }

  getEtapasProyecto(idProyecto: number): Observable<Etapa[]> {
    return this.http.get<any>('http://localhost:8080/api/proyectos/' + idProyecto + '/etapas');
  }

  getEtapaActiva(idProyecto: number): Observable<EtapaProyecto> {
    return this.http.get<any>('http://localhost:8080/api/proyectos/' + idProyecto + '/etapa-proyecto-activa');
  }

  aprobacionSecretaria(idProyecto: number) {
    return this.http.post<any>('http://localhost:8080/api/proyectos/' + idProyecto + '/aprobar-cambios-secretaria', {});
  }

  aprobacionSupervisor(idProyecto: number, usuario: Usuario) {
    return this.http.post<any>('http://localhost:8080/api/proyectos/' + idProyecto + '/aprobar-cambios-supervisor', usuario);
  }

  aprobacionInformeFinalSupervisor(idProyecto: number) {
    return this.http.post<any>('http://localhost:8080/api/proyectos/' + idProyecto + '/aprobar-informe-final-supervisor', {});
  }

  habilitarBitacora(idProyecto: number, usuario: Usuario) {
    return this.http.post<any>('http://localhost:8080/api/proyectos/' + idProyecto + '/habilitar-bitacora', usuario);
  }

  comentar(idProyecto: number, comentario: Comentario): Observable<Comentario> {
    return this.http.post<any>('http://localhost:8080/api/proyectos/' + idProyecto + '/comentarios', comentario);
  }

  solicitarCambios(idProyecto: number, comentario: Comentario): Observable<Comentario> {
    return this.http.post<any>('http://localhost:8080/api/proyectos/' + idProyecto + '/solicitar-cambios', comentario);
  }

  solicitarRevision(idProyecto: number) {
    return this.http.post<any>('http://localhost:8080/api/proyectos/' + idProyecto + '/solicitar-revision', {});
  }

  crearConvocatoriaAnteproyecto(idProyecto: number, convocatoria: Convocatoria) {
    return this.http.post<any>('http://localhost:8080/api/proyectos/' + idProyecto + '/convocatoria-anteproyecto', convocatoria);
  }

  actualizarConvocatoriaAnteproyecto(idProyecto: number, convocatoria: Convocatoria) {
    return this.http.put<any>('http://localhost:8080/api/proyectos/' + idProyecto + '/convocatoria-anteproyecto', convocatoria);
  }

  getConvocatoriaAnteproyecto(idProyecto: number): Observable<Convocatoria> {
    return this.http.get<any>('http://localhost:8080/api/proyectos/' + idProyecto + '/convocatoria-anteproyecto');
  }

  getConvocatoriaExamenGeneral(idProyecto: number): Observable<Convocatoria> {
    return this.http.get<any>('http://localhost:8080/api/proyectos/' + idProyecto + '/convocatoria-examen-general');
  }

  getActaAnteproyecto(idProyecto: number): Observable<Acta> {
    return this.http.get<any>('http://localhost:8080/api/proyectos/' + idProyecto + '/acta-anteproyecto');
  }

  getActaExamenGeneral(idProyecto: number): Observable<Acta> {
    return this.http.get<any>('http://localhost:8080/api/proyectos/' + idProyecto + '/acta-examen-general');
  }

  crearActa(idProyecto: number, acta: Acta) {
    return this.http.post<any>('http://localhost:8080/api/proyectos/' + idProyecto + '/acta', acta);
  }

  generarActaAnteproyecto(idProyecto: number, acta: Acta): Observable<Acta> {
    return this.http.post<any>('http://localhost:8080/api/proyectos/' + idProyecto + '/generar-acta-anteproyecto', acta);
  }

  generarActaExamenGeneral(idProyecto: number, acta: Acta): Observable<Acta> {
    return this.http.post<any>('http://localhost:8080/api/proyectos/' + idProyecto + '/generar-acta-examen-general', acta);
  }

  generarActaAprobacion(idProyecto: number, acta: Acta): Observable<Acta> {
    return this.http.post<any>('http://localhost:8080/api/proyectos/' + idProyecto + '/generar-acta-aprobacion', acta);
  }

  getFechaEvaluacionAnteproyecto(idProyecto: number): Observable<Evaluacion> {
    return this.http.get<any>('http://localhost:8080/api/proyectos/' + idProyecto + '/fecha-evaluacion-anteproyecto');
  }
  cambiarFechaEvaluacionAnteproyecto(idProyecto: number, evaluacion: Evaluacion) {
    return this.http.put<any>('http://localhost:8080/api/proyectos/' + idProyecto + '/fecha-evaluacion-anteproyecto', evaluacion);
  }
  ...
  subirNota(idProyecto: number, evaluacion: Evaluacion) {
    return this.http.post<any>('http://localhost:8080/api/proyectos/' + idProyecto + '/subir-nota', evaluacion);
  }

  getCoordinadorCarrera(idProyecto: number): Observable<Usuario> {
    return this.http.get<any>('http://localhost:8080/api/proyectos/' + idProyecto + '/usuarios/coordinador-carrera');
  }

  getResultado(idProyecto: number): Observable<Evaluacion> {
    return this.http.get<any>('http://localhost:8080/api/proyectos/' + idProyecto + '/resultado');
  }

  agregarBitacora(idProyecto: number, bitacora: Bitacora): Observable<Bitacora> {
    return this.http.post<any>('http://localhost:8080/api/proyectos/' + idProyecto + '/bitacoras', bitacora);
  }
  ...
  cargarDictamenRevision(idProyecto: number, dictamenRevision: any, cartaRevision: any) {
    ...
    return this.http.post<any>('http://localhost:8080/api/proyectos/' + idProyecto + '/cargar-dictamen-revision', formData);
  }
